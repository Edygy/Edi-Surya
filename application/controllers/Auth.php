...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'bungaadindas2304@gmail.com'; //email yg dirubah keamanannya
        $config['smtp_pass'] = 'eshgodjmbfbovhyv';
        ...
        $this->email->form('bungaadindas2304@gmail.com');
    ...
    public function resetpassword()
    {
        $email = $this->input->get('email');
        $token = $this->input->get('token');
        $user = $this->input->get_where('user', ['email' => $email])->row_array();
        if ($user) {
